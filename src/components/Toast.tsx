  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`shrink-0 p-0.5 rounded-md hover:bg-black/5 dark:hover:bg-white/5 transition-colors focus-visible:ring-2 focus-visible:ring-offset-1 focus-visible:ring-current outline-none ${config.text}`}
      >
