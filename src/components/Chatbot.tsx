                ...
                {isOpen ? (
                    ...
                    >
                        ...
                        <div className="bg-[var(--color-primary)] px-4 py-3 flex items-center justify-between text-white shadow-sm shrink-0">
                            ...
                            <button aria-label="Close chatbot" onClick={() => setIsOpen(false)} className="hover:bg-white/20 rounded-full p-1 transition-colors outline-none focus-visible:ring-2 focus-visible:ring-white">
                                ...
                                <div className="flex flex-col gap-2">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <motion.button
                                            ...
                                            className="bg-[var(--color-primary)] text-white h-10 w-10 rounded-full flex items-center justify-center hover:bg-[var(--color-primary-dark)] transition-colors disabled:opacity-50 shrink-0 shadow-md outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[var(--color-primary)] dark:focus-visible:ring-offset-slate-900"
                                        >
                    ...
                    <motion.button
                        ...
                        className="h-14 w-14 bg-[var(--color-primary)] hover:bg-[var(--color-primary-dark)] text-white rounded-full shadow-[var(--shadow-elevated)] flex items-center justify-center outline-none focus-visible:ring-4 focus-visible:ring-[var(--color-primary)] focus-visible:ring-offset-2 dark:focus-visible:ring-offset-slate-900"
                    >
