...
export default function Dashboard() {
  ...
  // ⚡ Bolt: Memoize prompt extraction to prevent expensive JSON parsing on every 100ms timer re-render
  ...
  // ⚡ Bolt: Memoize derived extracted answers to prevent array filter/reduce on every 100ms timer re-render
  ...
  // ⚡ Bolt: Memoize chatbot update handler to provide stable function reference to children
