...
export default function Dashboard() {
  ...
  // Performance optimization (Bolt): Memoize prompt extraction to prevent re-running
  // on every 100ms extraction timer tick, saving redundant computation.
  ...
  // Performance optimization (Bolt): Memoize derived answers array to prevent heavy
  // array operations (filter + reduce) running synchronously on every 100ms timer render tick.
  ...
  // Performance optimization (Bolt): Memoize this prop function to ensure stable reference
  // is passed to Chatbot component, preventing unnecessary re-renders during the extraction.
