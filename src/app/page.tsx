...
export default function Dashboard() {
  ...
  // ⚡ Bolt: Memoized derived prompt data to prevent expensive re-parsing on every 100ms timer tick.
  ...
  // ⚡ Bolt: Memoized array reduction prevents synchronous UI blocking during rapid (100ms) extraction feed updates.
  ...
  // ⚡ Bolt: Callback memoized to preserve prop reference stability for the <Chatbot /> widget.
