...
export default function Dashboard() {
  ...
  // Memoized to prevent heavy re-extraction during the 100ms extraction timer ticks
  ...
  // Memoized to prevent recalculating answers array and mapping keys on every 100ms timer tick
  ...
  // Memoized to avoid recreating this function and causing child component re-renders
